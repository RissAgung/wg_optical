  ...
  <div class="w-full h-16 bg-white flex items-center md:justify-between md:px-5 justify-between px-6 overflow-hidden">
    ...
    <div class="flex flex-row items-center">
      <div class="mr-4">
        ...
        <!-- notfication -->
        <div id="notif" class="w-[254px] h-[379px] hidden transition ease-in-out flex-col absolute bg-white rounded-md shadow-md border-[1px] mt-3 max-[356px]:mr-10 mr-12 p-[13px] right-0">
