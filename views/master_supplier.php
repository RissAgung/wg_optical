    ...
    <div class="lg:ml-72">
        ...
        <div class="mt-3 flex items-center flex-col md:flex-row md:justify-around lg:justify-between lg:px-16 md:py-[3px]">
            ...
            <div class="flex flex-row shadow-sm rounded-md items-center bg-white box-border px-2 md:mr-6">
                ...
                <input type="text" placeholder="Cari Supplier" class="h-11 bg-transparent ml-2 outline-none" />
            </div>
            <!-- End Search -->
                ...
                <table class="w-full ">
                    <thead class="border-b-2 border-gray-100">
                        <tr>
                            ...
                            <th class="p-3 text-sm tracking-wide text-center">ID Supplier</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="p-3 text-sm tracking-wide text-center">Rizal</td>
                            ...
                            <td class="p-3 text-sm tracking-wide text-center">Frame A</td>
