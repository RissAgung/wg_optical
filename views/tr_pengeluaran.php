...
<body class="bg-[#F0F0F0] font-ex-color box-border">
                    ...
                    <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="p-3 text-sm tracking-wide text-center"><?php echo $data['tanggal'] ?></td>
                                <td class="p-3 text-sm tracking-wide text-center"><?php echo $data['id_pegawai'] ?></td>
                                <td class="p-3 text-sm tracking-wide text-center"><?php echo $data['id_Supplier'] ?></td>
                                <td class="p-3 text-sm tracking-wide text-center"><?php echo $data['kategori2'] ?></td>                                
                                <td class="p-3 text-sm tracking-wide text-center"><?php echo $data['kode_frame'] ?></td>
                                <td class="p-3 text-sm tracking-wide text-center"><?php echo $data['qty'] ?></td>
                            </tr>
                            <script>
    ...
    $("#modal").load("../assets/components/modal_pengeluaran.php", function() {   
        ...
        $('#tabRestock').on('click', function() {
            ...
            $('#field-supplier').removeClass("hidden");
        ...
        $("#btn_tambah").on("click", function(e) {
            ...
            formData.append('query', "INSERT INTO tr_pengeluaran VALUES ('" + kode + "' ,'" + tgl + "','" + idPegawai + "','operasional','" + keterangan + "','" + total + "')");
    ...
    function tableHtmlToExcel(tableID, filename = ''){
        ...
        filename = filename?filename+'.xls':'Laporan Pengeluaran.xls';   
