    ...
    <div class="w-[90%] mx-auto mt-4 h-full text-sm p-5 bg-white rounded-md relative">
      ...
      <div>
        <div class="flex flex-row">
          <h2 class="mr-8 font-ex-semibold">Pembelian</h2>
          <h2 class="mr-8">Di proses</h2>
          <h2>Pembayaran</h2>
        </div>
        <hr class="mt-3 bg-[#343948] h-[0.3px]">
        <div id="tab" class="h-[5px] w-[80px] bg-[#209F80] rounded-md absolute top-[50px]"></div>
      </div>
      <!-- end tab bar -->

      <!-- table -->
      <div class="flex mt-12 overflow-x-auto">
        <table class="w-full">
