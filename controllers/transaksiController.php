...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST["type"])) {
        if ($_POST["type"] == "insert_lunas") {
            ...
            // insert transaksi
            $crud->execute("INSERT INTO transaksi VALUES ('" . generateTransaksiID($data) . "', '1', NOW(), '" . $_SESSION["idPeg"] . "', '" . $_POST['total'] . "', '" . $_POST['total_harga'] . "', '" . $_POST['kembalian'] . "', '" . $idCus . "', '" . $_POST['tgljatuhtempo'] . "', 'NULL')");
