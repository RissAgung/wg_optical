      ...
      if (variant.length == 0) {
        ...
        $.ajax({
          ...
          data: {
            ...
            query_Detail_keranjang: "INSERT INTO `detail_keranjang` (`kode_detail_lensa_keranjang`, `kode_pesanan`, `id_bawa`, `nominal`) VALUES ('" + kode_detail_lens + "', '" + idTR + "', '" + kode + "', '" + hargaFrame + "')",
            query_Keranjang_Lensa: "INSERT INTO `keranjang_lensa`(`kode_varian_lensa_keranjang`, `kode_detail_lensa_keranjang`, `id_jenis_lensa`) VALUES ('" + kode_varian_lensa + "','" + kode_detail_lens + "','" + jenis_lensa + "')",
