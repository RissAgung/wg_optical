    ...
    <div class="flex w-full lg:h-[75vh] my-[23px] justify-center items-center">
      <div class="flex lg:flex-row flex-col w-[93%] h-full rounded-lg bg-white shadow-md p-5">
        ...
        <div class="flex flex-col max-md:items-center lg:h-full h-[400px] lg:w-[65%] border-2 rounded-md p-[10px] md:p-[20px] mb-[10px]">
          <button id="btn_add_header" class="bg-[#1C8066] hover:bg-[#145b48] transition ease-in-out text-white rounded-md p-2 w-40 mb-[10px] font-ex-medium">Tambah Gambar</button>
            ...
            <?php for ($i = 1; $i <= 10; $i++) : ?>
              <div class="relative max-md:w-full max-[1023px]:w-[31%] w-[30%] max-lg:h-[50%] h-[30%] overflow-hidden rounded-md">
                <div id="hapus_gambar<?= $i ?>" class="absolute flex justify-center items-center w-full h-full bg-black opacity-50">
                  ...
                  <svg onclick="delete_img('hapus<?= $i ?>')" class="cursor-pointer" id="hapus<?= $i ?>" width="25" height="27" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <img src="../assets/images/heroimg.png" id="img-<?= $i ?>" onmouseover="mouseIn('img-<?= $i ?>', 'hapus_gambar<?= $i ?>')" class="transition ease-in-out absolute w-full h-full object-cover">
              </div>
            <?php endfor ?>
          </div>
        </div>
        ...
        <div class="flex flex-col lg:h-full h-[400px] lg:w-[35%] justify-between lg:pl-5 max-lg:mt-5">
          ...
          <input type="text" class="outline-none h-[15%] w-full border-2 rounded-md p-3">

          <textarea class="w-full h-[60%] outline-none border-2 rounded-md p-3"></textarea>

          <div class="cursor-pointer flex justify-center items-center text-white font-ex-semibold h-[16%] w-full rounded-md bg-[#393e4c] hover:bg-[#343948]">
            Apply
          </div>
