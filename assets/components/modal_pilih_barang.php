...
<body class=" bg-slate-600 text-[#343948] font-ex-medium">
    <!-- Modal -->
    <!-- Background -->
    <div id="bgmodal" class="hidden w-full h-screen fixed  bg-black z-[51] opacity-0 transition duration-300"></div>
    <!-- konten modal-->
    <div id="modalkonten" class=" bg-white fixed z-[51] left-[50%] top-[50%] -translate-y-[50%] -translate-x-[50%] shadow-xl rounded-lg scale-0 transition ease-in-out">
        <div class="header relative">
            ...
            <div id="closemodal" class="absolute right-5 top-5 cursor-pointer flex text-center my-auto rounded-md transition">
