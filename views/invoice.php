...
<body class="bg-[#F0F0F0] font-ex-color box-border text-[#343948]">
  ...
  <div class="lg:ml-72">
    ...
    <!-- main content -->
    <div class="w-[90%] mx-auto mt-4 h-full text-sm p-5 bg-white rounded-md relative">
      ...
      <div>
        <div class="flex flex-row">
          ...
          <h2 class="cursor-pointer" id="tab_Pembayaran">Pembayaran</h2>
        </div>
      ...
      <!-- table pembelian -->
      <div class="flex mt-12 overflow-x-auto" id="table_Pembelian">
        <table class="w-full">
      ...
      <!-- table di Proses-->
      <div class="mt-12 overflow-x-auto hidden" id="table_Proses">
        <table class="w-full">
          <thead class="font-ex-bold border-b-2 border-gray-100">
            <tr>
              <th class="p-3 text-sm tracking-wide text-center">
      ...
      <!-- table Pembayaran-->
      <div class="mt-12 overflow-x-auto hidden" id="table_Pembayaran">
        <table class="w-full">
          <thead class="font-ex-bold border-b-2 border-gray-100">
            <tr>
              <th class="p-3 text-sm tracking-wide text-center">
      ...
      <div class="flex flex-col-reverse mt-[30px] items-center">
        <div class="flex flex-row justify-center">
          <?php for ($i = 1; $i <= 6; $i++) : ?>
            <div class="flex justify-center items-center h-10 w-10 mr-2 rounded-sm font-ex-bold bg-white border-solid border-[1px] border-[#DADADA] hover:bg-[#5C6171] hover:text-white transition ease-in-out"><?= $i ?></div>
          <?php endfor ?>
        </div>
  ...
  <script>
    ...
    $('#tab_Pembelian').on("click", function(){
      ...
      $('#tab').removeClass("translate-x-[106px]");
    ...
    $('#tab_Proses').on("click", function(){
      ...
      $('#tab').addClass("translate-x-[106px]");
      $('#tab').removeClass("translate-x-[215px]");
