...
<head>
  ...
  <title>Keranjang | WG Optical</title>
...
<body class="scrollbar-hide bg-[#ECECEC]">
  ...
  <section id="keranjang" class="">
    ...
    <section id="header" class="fixed z-[50] w-full top-0">
      <div class="flex flex-row px-8 py-6 justify-between shadow-sm bg-white">
        ...
        <div onclick="deleteKeranjangSelected()">
          ...
          <div class="bg-white my-4 mx-6 rounded-lg shadow-sm">
            <div class="flex flex-row relative">
              ...
              <div class="flex flex-row h-full w-full absolute justify-end gap-3 p-3">
                ...
                <div class="cursor-pointer" onclick="deleteKeranjang('<?= $index['kode_pesanan'] ?>')">
  ...
  <script>
    ...
    function deleteKeranjang(idtransaksi) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: '../controllers/hapusKeranjangController.php',
            type: 'POST',
            data: {
              'kode_tr': idtransaksi,
              'type': "hapus"
    ...
    function deleteKeranjangSelected() {
      if (kodeTR.length !== 0) {
        Swal.fire({
          title: 'Hapus Data Keranjang',
          text: "Apakah anda yakin ingin menghapus data?",
